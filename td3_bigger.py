...
from networks_bigger import ActorNetwork, CriticNetwork


class Agent:
    def __init__(self, alpha, beta, input_dims, tau, env, gamma=0.99,
                 update_actor_interval=2, warmup=1000, n_actions=2,
                 max_size=2000000, layer1_size=1024, layer2_size=512,
                 batch_size=100, noise=0.3, chkpt_dir='./checkpoints/td3_bigger'):
    ...
    def save_best_models(self):
        ...
        self.critic_1.save_best()
        self.critic_2.save_best()
        self.target_critic_1.save_best()
        self.target_critic_2.save_best()

    def load_best_models(self):
        self.actor.load_best()
        self.target_actor.load_best()
        self.critic_1.load_best()
        self.critic_2.load_best()
        self.target_critic_1.load_best()
        self.target_critic_2.load_best()
