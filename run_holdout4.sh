...
: > $O/jobs.txt
add c2m512s1 checkpoints/td3_grasp_rand_td3_ln_c2m512_s1/best Results/big2m/c2m512_s1_int8.tflite
add buf500ks1 checkpoints/td3_grasp_rand_td3_ln_buf500k_s1/best Results/buffer/buf500k_s1_int8.tflite
add c2m64s3 checkpoints/td3_grasp_rand_td3_ln_c2m64_s3/best Results/big2m/c2m64_s3_int8.tflite
