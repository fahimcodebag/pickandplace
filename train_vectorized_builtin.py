...
Uses robosuite's built-in reward_shaping=True (dense distance-based reward).
"""
...
def train(env_name="PickPlace", n_envs=8, n_episodes=20000):
    print("=" * 70)
    print(f"TRAINING: {env_name} (built-in reward shaping)")
    print("=" * 70)
    ...
    log_dir = os.path.join(".", "logs", f"{env_name}_vectorized_builtin")
...
if __name__ == "__main__":
    ...
    print(f"\n{'=' * 70}")
    print("TRAINING (built-in reward shaping)")
    print(f"{'=' * 70}")
