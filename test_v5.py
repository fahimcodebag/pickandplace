#!/usr/bin/env python3
"""Test script for the TD3 v5 model (built-in reward, larger network)."""
...
if __name__ == '__main__':
    ...
    agent = Agent(
        ...
        layer1_size=2048,       # must match v5 training
        layer2_size=1024,       # must match v5 training
        batch_size=1024,
        n_critics=4,
        chkpt_dir='./checkpoints/td3_v5',
    )

    print("Loading trained models from ./checkpoints/td3_v5/ ...")
    try:
        agent.load_models()
